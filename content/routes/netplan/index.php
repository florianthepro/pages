...
$dataDir     = (isset($netplan_datadir) && is_string($netplan_datadir) && $netplan_datadir !== '') ? $netplan_datadir : __DIR__ . '/data';
$__nptheme   = (isset($netplan_theme) && in_array($netplan_theme, ['light','dark'], true)) ? $netplan_theme : 'auto';
...
<?php if($__nptheme==='dark'): ?>:root {
    ...
    }<?php elseif($__nptheme!=='light'): ?>@media (prefers-color-scheme: dark) { :root {
        --blue: #0a84ff;
        --red: #ff453a;
        --green: #30d158;
        --orange: #ff9f0a;
