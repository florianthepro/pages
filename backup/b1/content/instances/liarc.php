...
#eindeutiger dateiname (pro branch), 1 tag gueltig - vermeidet shared-hosting-probleme
$__loaderUrl=$liarc_repo.'/loader/loader.php';
...
$__loaderFile=$__tmp.'/pages_loader_'.substr(sha1(__DIR__.$liarc_branch),0,10).'.php';
