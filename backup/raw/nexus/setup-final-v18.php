...
function nx_webapps(): array {
    return []; // nur noch nativ von Nexus entwickelte Apps
}
...
function render_store(array $u): void {
    ...
    echo '<p class="note-line" style="max-width:560px;margin-top:14px">Es werden nur Apps angeboten, die nativ in Nexus entwickelt sind.</p>';
}
