...
function nx_apps(): array {
    return [
        ...
        // Web-App-Viewer (nativ eingebettete Store-Apps wie YouTube/Karte)
...
function nx_store_builtins(): array {
    return ['chat', 'mail', 'notes', 'tasks', 'calendar', 'contacts', 'files', 'passwords'];
}
...
function nx_webapps(): array {
    return [
        'youtube'      => ['name'=>'YouTube','cat'=>'Video','embed'=>true,'kind'=>'youtube','frame'=>'https://www.youtube-nocookie.com','url'=>'','hint'=>'YouTube-Link oder Video-ID einfügen'],
        'osm'          => ['name'=>'Karte (OSM)','cat'=>'Tools','embed'=>true,'kind'=>'embed','frame'=>'https://www.openstreetmap.org','url'=>'https://www.openstreetmap.org/export/embed.html?layer=mapnik'],
        'weather'      => ['name'=>'Wetter','cat'=>'Tools','embed'=>true,'kind'=>'embed','frame'=>'https://wttr.in','url'=>'https://wttr.in/?format=v2'],
        'amazon'         => ['name'=>'Amazon','cat'=>'Shopping','embed'=>false,'url'=>'https://www.amazon.de'],
        'ebay'           => ['name'=>'eBay','cat'=>'Shopping','embed'=>false,'url'=>'https://www.ebay.de'],
        'kleinanzeigen'  => ['name'=>'Kleinanzeigen','cat'=>'Shopping','embed'=>false,'url'=>'https://www.kleinanzeigen.de'],
        'aliexpress'     => ['name'=>'AliExpress','cat'=>'Shopping','embed'=>false,'url'=>'https://www.aliexpress.com'],
        'otto'           => ['name'=>'Otto','cat'=>'Shopping','embed'=>false,'url'=>'https://www.otto.de'],
        'zalando'        => ['name'=>'Zalando','cat'=>'Shopping','embed'=>false,'url'=>'https://www.zalando.de'],
        'etsy'           => ['name'=>'Etsy','cat'=>'Shopping','embed'=>false,'url'=>'https://www.etsy.com'],
        'mediamarkt'     => ['name'=>'MediaMarkt','cat'=>'Shopping','embed'=>false,'url'=>'https://www.mediamarkt.de'],
        'saturn'         => ['name'=>'Saturn','cat'=>'Shopping','embed'=>false,'url'=>'https://www.saturn.de'],
        'ikea'           => ['name'=>'IKEA','cat'=>'Shopping','embed'=>false,'url'=>'https://www.ikea.com/de'],
        'lidl'           => ['name'=>'Lidl','cat'=>'Shopping','embed'=>false,'url'=>'https://www.lidl.de'],
        'aldi'           => ['name'=>'Aldi','cat'=>'Shopping','embed'=>false,'url'=>'https://www.aldi-sued.de'],
        'kaufland'       => ['name'=>'Kaufland','cat'=>'Shopping','embed'=>false,'url'=>'https://www.kaufland.de'],
        'shein'          => ['name'=>'Shein','cat'=>'Shopping','embed'=>false,'url'=>'https://www.shein.com'],
        'temu'           => ['name'=>'Temu','cat'=>'Shopping','embed'=>false,'url'=>'https://www.temu.com'],
        'idealo'         => ['name'=>'Idealo','cat'=>'Shopping','embed'=>false,'url'=>'https://www.idealo.de'],
        'check24'        => ['name'=>'Check24','cat'=>'Shopping','embed'=>false,'url'=>'https://www.check24.de'],
        'notebooksbilliger' => ['name'=>'Notebooksbilliger','cat'=>'Shopping','embed'=>false,'url'=>'https://www.notebooksbilliger.de'],
        'decathlon'      => ['name'=>'Decathlon','cat'=>'Shopping','embed'=>false,'url'=>'https://www.decathlon.de'],
        'thomann'        => ['name'=>'Thomann','cat'=>'Shopping','embed'=>false,'url'=>'https://www.thomann.de'],
        'facebook'       => ['name'=>'Facebook','cat'=>'Social','embed'=>false,'url'=>'https://www.facebook.com'],
        'instagram'      => ['name'=>'Instagram','cat'=>'Social','embed'=>false,'url'=>'https://www.instagram.com'],
        'x'              => ['name'=>'X (Twitter)','cat'=>'Social','embed'=>false,'url'=>'https://x.com'],
        'tiktok'         => ['name'=>'TikTok','cat'=>'Social','embed'=>false,'url'=>'https://www.tiktok.com'],
        'snapchat'       => ['name'=>'Snapchat','cat'=>'Social','embed'=>false,'url'=>'https://web.snapchat.com'],
        'reddit'         => ['name'=>'Reddit','cat'=>'Social','embed'=>false,'url'=>'https://www.reddit.com'],
        'linkedin'       => ['name'=>'LinkedIn','cat'=>'Social','embed'=>false,'url'=>'https://www.linkedin.com'],
        'pinterest'      => ['name'=>'Pinterest','cat'=>'Social','embed'=>false,'url'=>'https://www.pinterest.de'],
        'tumblr'         => ['name'=>'Tumblr','cat'=>'Social','embed'=>false,'url'=>'https://www.tumblr.com'],
        'threads'        => ['name'=>'Threads','cat'=>'Social','embed'=>false,'url'=>'https://www.threads.net'],
        'mastodon'       => ['name'=>'Mastodon','cat'=>'Social','embed'=>false,'url'=>'https://mastodon.social'],
        'bluesky'        => ['name'=>'Bluesky','cat'=>'Social','embed'=>false,'url'=>'https://bsky.app'],
        'discord'        => ['name'=>'Discord','cat'=>'Social','embed'=>false,'url'=>'https://discord.com/app'],
        'telegram'       => ['name'=>'Telegram','cat'=>'Social','embed'=>false,'url'=>'https://web.telegram.org'],
        'whatsapp'       => ['name'=>'WhatsApp','cat'=>'Social','embed'=>false,'url'=>'https://web.whatsapp.com'],
        'signal'         => ['name'=>'Signal','cat'=>'Social','embed'=>false,'url'=>'https://signal.org'],
        'xing'           => ['name'=>'Xing','cat'=>'Social','embed'=>false,'url'=>'https://www.xing.com'],
        'netflix'        => ['name'=>'Netflix','cat'=>'Video','embed'=>false,'url'=>'https://www.netflix.com'],
        'disneyplus'     => ['name'=>'Disney+','cat'=>'Video','embed'=>false,'url'=>'https://www.disneyplus.com'],
        'primevideo'     => ['name'=>'Prime Video','cat'=>'Video','embed'=>false,'url'=>'https://www.primevideo.com'],
        'twitch'         => ['name'=>'Twitch','cat'=>'Video','embed'=>true,'kind'=>'twitch','frame'=>'https://player.twitch.tv','hint'=>'Twitch-Kanalname eingeben'],
        'vimeo'          => ['name'=>'Vimeo','cat'=>'Video','embed'=>true,'kind'=>'vimeo','frame'=>'https://player.vimeo.com','hint'=>'Vimeo-Link oder Video-ID einfügen'],
        'dazn'           => ['name'=>'DAZN','cat'=>'Video','embed'=>false,'url'=>'https://www.dazn.com'],
        'ardmediathek'   => ['name'=>'ARD Mediathek','cat'=>'Video','embed'=>false,'url'=>'https://www.ardmediathek.de'],
        'zdf'            => ['name'=>'ZDF Mediathek','cat'=>'Video','embed'=>false,'url'=>'https://www.zdf.de'],
        'rtlplus'        => ['name'=>'RTL+','cat'=>'Video','embed'=>false,'url'=>'https://plus.rtl.de'],
        'joyn'           => ['name'=>'Joyn','cat'=>'Video','embed'=>false,'url'=>'https://www.joyn.de'],
        'spotify'        => ['name'=>'Spotify','cat'=>'Musik','embed'=>true,'kind'=>'spotify','frame'=>'https://open.spotify.com','hint'=>'Spotify-Link (Song/Album/Playlist) einfügen'],
        'soundcloud'     => ['name'=>'SoundCloud','cat'=>'Musik','embed'=>true,'kind'=>'soundcloud','frame'=>'https://w.soundcloud.com','hint'=>'SoundCloud-Track-Link einfügen'],
        'applemusic'     => ['name'=>'Apple Music','cat'=>'Musik','embed'=>false,'url'=>'https://music.apple.com'],
        'deezer'         => ['name'=>'Deezer','cat'=>'Musik','embed'=>false,'url'=>'https://www.deezer.com'],
        'bandcamp'       => ['name'=>'Bandcamp','cat'=>'Musik','embed'=>false,'url'=>'https://bandcamp.com'],
        'gmail'          => ['name'=>'Gmail','cat'=>'Mail','embed'=>false,'url'=>'https://mail.google.com'],
        'outlook'        => ['name'=>'Outlook','cat'=>'Mail','embed'=>false,'url'=>'https://outlook.live.com'],
        'gmx'            => ['name'=>'GMX','cat'=>'Mail','embed'=>false,'url'=>'https://www.gmx.net'],
        'webde'          => ['name'=>'Web.de','cat'=>'Mail','embed'=>false,'url'=>'https://web.de'],
        'proton'         => ['name'=>'Proton Mail','cat'=>'Mail','embed'=>false,'url'=>'https://mail.proton.me'],
        'yahoomail'      => ['name'=>'Yahoo Mail','cat'=>'Mail','embed'=>false,'url'=>'https://mail.yahoo.com'],
        'zoom'           => ['name'=>'Zoom','cat'=>'Mail','embed'=>false,'url'=>'https://app.zoom.us'],
        'meet'           => ['name'=>'Google Meet','cat'=>'Mail','embed'=>false,'url'=>'https://meet.google.com'],
        'teams'          => ['name'=>'Teams','cat'=>'Mail','embed'=>false,'url'=>'https://teams.microsoft.com'],
        'spiegel'        => ['name'=>'Spiegel','cat'=>'News','embed'=>false,'url'=>'https://www.spiegel.de'],
        'bild'           => ['name'=>'Bild','cat'=>'News','embed'=>false,'url'=>'https://www.bild.de'],
        'zeit'           => ['name'=>'Zeit','cat'=>'News','embed'=>false,'url'=>'https://www.zeit.de'],
        'faz'            => ['name'=>'FAZ','cat'=>'News','embed'=>false,'url'=>'https://www.faz.net'],
        'tagesschau'     => ['name'=>'Tagesschau','cat'=>'News','embed'=>false,'url'=>'https://www.tagesschau.de'],
        'ntv'            => ['name'=>'n-tv','cat'=>'News','embed'=>false,'url'=>'https://www.n-tv.de'],
        'welt'           => ['name'=>'Welt','cat'=>'News','embed'=>false,'url'=>'https://www.welt.de'],
        'sueddeutsche'   => ['name'=>'SZ','cat'=>'News','embed'=>false,'url'=>'https://www.sueddeutsche.de'],
        'heise'          => ['name'=>'Heise','cat'=>'News','embed'=>false,'url'=>'https://www.heise.de'],
        'golem'          => ['name'=>'Golem','cat'=>'News','embed'=>false,'url'=>'https://www.golem.de'],
        'bbc'            => ['name'=>'BBC','cat'=>'News','embed'=>false,'url'=>'https://www.bbc.com'],
        'cnn'            => ['name'=>'CNN','cat'=>'News','embed'=>false,'url'=>'https://www.cnn.com'],
        'guardian'       => ['name'=>'Guardian','cat'=>'News','embed'=>false,'url'=>'https://www.theguardian.com'],
        'nytimes'        => ['name'=>'NY Times','cat'=>'News','embed'=>false,'url'=>'https://www.nytimes.com'],
        'google'         => ['name'=>'Google','cat'=>'Tools','embed'=>false,'url'=>'https://www.google.com'],
        'bing'           => ['name'=>'Bing','cat'=>'Tools','embed'=>false,'url'=>'https://www.bing.com'],
        'duckduckgo'     => ['name'=>'DuckDuckGo','cat'=>'Tools','embed'=>false,'url'=>'https://duckduckgo.com'],
        'gdrive'         => ['name'=>'Google Drive','cat'=>'Tools','embed'=>false,'url'=>'https://drive.google.com'],
        'gdocs'          => ['name'=>'Google Docs','cat'=>'Tools','embed'=>false,'url'=>'https://docs.google.com'],
        'gcal'           => ['name'=>'Google Kalender','cat'=>'Tools','embed'=>false,'url'=>'https://calendar.google.com'],
        'gmaps'          => ['name'=>'Google Maps','cat'=>'Tools','embed'=>true,'kind'=>'gmaps','frame'=>'https://www.google.com','hint'=>'Ort oder Adresse suchen'],
        'gphotos'        => ['name'=>'Google Fotos','cat'=>'Tools','embed'=>false,'url'=>'https://photos.google.com'],
        'translate'      => ['name'=>'Google Übersetzer','cat'=>'Tools','embed'=>false,'url'=>'https://translate.google.com'],
        'deepl'          => ['name'=>'DeepL','cat'=>'Tools','embed'=>false,'url'=>'https://www.deepl.com/translator'],
        'notion'         => ['name'=>'Notion','cat'=>'Tools','embed'=>false,'url'=>'https://www.notion.so'],
        'trello'         => ['name'=>'Trello','cat'=>'Tools','embed'=>false,'url'=>'https://trello.com'],
        'todoist'        => ['name'=>'Todoist','cat'=>'Tools','embed'=>false,'url'=>'https://todoist.com'],
        'dropbox'        => ['name'=>'Dropbox','cat'=>'Tools','embed'=>false,'url'=>'https://www.dropbox.com'],
        'onedrive'       => ['name'=>'OneDrive','cat'=>'Tools','embed'=>false,'url'=>'https://onedrive.live.com'],
        'evernote'       => ['name'=>'Evernote','cat'=>'Tools','embed'=>false,'url'=>'https://www.evernote.com'],
        'canva'          => ['name'=>'Canva','cat'=>'Tools','embed'=>false,'url'=>'https://www.canva.com'],
        'figma'          => ['name'=>'Figma','cat'=>'Tools','embed'=>false,'url'=>'https://www.figma.com'],
        'miro'           => ['name'=>'Miro','cat'=>'Tools','embed'=>false,'url'=>'https://miro.com'],
        'wetteronline'   => ['name'=>'WetterOnline','cat'=>'Tools','embed'=>false,'url'=>'https://www.wetteronline.de'],
        'github'         => ['name'=>'GitHub','cat'=>'Dev','embed'=>false,'url'=>'https://github.com'],
        'gitlab'         => ['name'=>'GitLab','cat'=>'Dev','embed'=>false,'url'=>'https://gitlab.com'],
        'stackoverflow'  => ['name'=>'Stack Overflow','cat'=>'Dev','embed'=>false,'url'=>'https://stackoverflow.com'],
        'codepen'        => ['name'=>'CodePen','cat'=>'Dev','embed'=>false,'url'=>'https://codepen.io'],
        'replit'         => ['name'=>'Replit','cat'=>'Dev','embed'=>false,'url'=>'https://replit.com'],
        'npm'            => ['name'=>'npm','cat'=>'Dev','embed'=>false,'url'=>'https://www.npmjs.com'],
        'mdn'            => ['name'=>'MDN','cat'=>'Dev','embed'=>false,'url'=>'https://developer.mozilla.org'],
        'dockerhub'      => ['name'=>'Docker Hub','cat'=>'Dev','embed'=>false,'url'=>'https://hub.docker.com'],
        'vercel'         => ['name'=>'Vercel','cat'=>'Dev','embed'=>false,'url'=>'https://vercel.com'],
        'netlify'        => ['name'=>'Netlify','cat'=>'Dev','embed'=>false,'url'=>'https://www.netlify.com'],
        'cloudflare'     => ['name'=>'Cloudflare','cat'=>'Dev','embed'=>false,'url'=>'https://dash.cloudflare.com'],
        'paypal'         => ['name'=>'PayPal','cat'=>'Finanzen','embed'=>false,'url'=>'https://www.paypal.com'],
        'n26'            => ['name'=>'N26','cat'=>'Finanzen','embed'=>false,'url'=>'https://app.n26.com'],
        'traderepublic'  => ['name'=>'Trade Republic','cat'=>'Finanzen','embed'=>false,'url'=>'https://app.traderepublic.com'],
        'coinbase'       => ['name'=>'Coinbase','cat'=>'Finanzen','embed'=>false,'url'=>'https://www.coinbase.com'],
        'binance'        => ['name'=>'Binance','cat'=>'Finanzen','embed'=>false,'url'=>'https://www.binance.com'],
        'revolut'        => ['name'=>'Revolut','cat'=>'Finanzen','embed'=>false,'url'=>'https://app.revolut.com'],
        'wikipedia'      => ['name'=>'Wikipedia','cat'=>'Wissen','embed'=>false,'url'=>'https://de.wikipedia.org'],
        'wolfram'        => ['name'=>'Wolfram Alpha','cat'=>'Wissen','embed'=>false,'url'=>'https://www.wolframalpha.com'],
        'duolingo'       => ['name'=>'Duolingo','cat'=>'Wissen','embed'=>false,'url'=>'https://www.duolingo.com'],
        'khan'           => ['name'=>'Khan Academy','cat'=>'Wissen','embed'=>false,'url'=>'https://www.khanacademy.org'],
        'coursera'       => ['name'=>'Coursera','cat'=>'Wissen','embed'=>false,'url'=>'https://www.coursera.org'],
        'udemy'          => ['name'=>'Udemy','cat'=>'Wissen','embed'=>false,'url'=>'https://www.udemy.com'],
        'chatgpt'        => ['name'=>'ChatGPT','cat'=>'Wissen','embed'=>false,'url'=>'https://chat.openai.com'],
        'scholar'        => ['name'=>'Google Scholar','cat'=>'Wissen','embed'=>false,'url'=>'https://scholar.google.com'],
        'archive'        => ['name'=>'Archive.org','cat'=>'Wissen','embed'=>false,'url'=>'https://archive.org'],
        'chefkoch'       => ['name'=>'Chefkoch','cat'=>'Wissen','embed'=>false,'url'=>'https://www.chefkoch.de'],
        'booking'        => ['name'=>'Booking','cat'=>'Reisen','embed'=>false,'url'=>'https://www.booking.com'],
        'airbnb'         => ['name'=>'Airbnb','cat'=>'Reisen','embed'=>false,'url'=>'https://www.airbnb.de'],
        'expedia'        => ['name'=>'Expedia','cat'=>'Reisen','embed'=>false,'url'=>'https://www.expedia.de'],
        'bahn'           => ['name'=>'Deutsche Bahn','cat'=>'Reisen','embed'=>false,'url'=>'https://www.bahn.de'],
        'flixbus'        => ['name'=>'FlixBus','cat'=>'Reisen','embed'=>false,'url'=>'https://www.flixbus.de'],
        'tripadvisor'    => ['name'=>'TripAdvisor','cat'=>'Reisen','embed'=>false,'url'=>'https://www.tripadvisor.de'],
        'mobilede'       => ['name'=>'Mobile.de','cat'=>'Reisen','embed'=>false,'url'=>'https://www.mobile.de'],
        'immoscout'      => ['name'=>'ImmoScout24','cat'=>'Reisen','embed'=>false,'url'=>'https://www.immobilienscout24.de'],
        'googleflights'  => ['name'=>'Google Flights','cat'=>'Reisen','embed'=>false,'url'=>'https://www.google.com/travel/flights'],
    ];
}
...
/** Baut die iframe-Quelle einer eingebetteten Web-App aus optionaler
 *  Nutzereingabe $v. Leerer Rueckgabewert => Eingabe noch noetig. */
function nx_embed_src(string $wid, array $w, string $v): string {
    $kind = $w['kind'] ?? 'embed';
    $v = trim($v);
    if ($kind === 'embed') {
        return (string) ($w['url'] ?? '');
    ...
    if ($kind === 'youtube') {
        return preg_match('#(?:v=|youtu\.be/|embed/|shorts/)?([A-Za-z0-9_-]{11})#', $v, $m)
            ? $w['frame'] . '/embed/' . $m[1] . '?rel=0' : '';
    }
    if ($kind === 'spotify') {
    ...
    if ($kind === 'soundcloud') {
        return preg_match('#^https?://(?:www\.|m\.)?soundcloud\.com/\S+#i', $v, $m)
            ? 'https://w.soundcloud.com/player/?url=' . rawurlencode($m[0]) . '&color=%23ff5500&auto_play=false' : '';
    }
    if ($kind === 'vimeo') {
        return preg_match('#(?:vimeo\.com/(?:video/)?)?(\d{6,})#', $v, $m)
...
function storeFilter(q){q=(q||'').toLowerCase().trim();document.querySelectorAll('.wacard').forEach(function(c){c.style.display=(!q||c.dataset.name.indexOf(q)>=0)?'':'none';});document.querySelectorAll('[data-store-group]').forEach(function(g){var any=Array.from(g.querySelectorAll('.wacard')).some(function(c){return c.style.display!=='none';});g.previousElementSibling&&g.previousElementSibling.classList.contains('section-h')&&(g.previousElementSibling.style.display=any?'':'none');g.style.display=any?'':'none';});}
...
function render_home(array $u): void {
    ...
    // Installierte Web-Apps: eingebettete oeffnen in Nexus, andere die Seite
    foreach (nx_webapps() as $wid => $w) {
        if (!in_array('web:' . $wid, $inst, true)) {
            continue;
        }
        $col = nx_wa_color($w['name']);
        if (!empty($w['embed'])) {
            echo '<a class="lapp" href="' . url('web', ['id' => $wid]) . '">';
        } else {
            echo '<a class="lapp" href="' . h($w['url']) . '" target="_blank" rel="noopener">';
        }
        echo '<span class="lico" style="--tc:' . $col . '">' . h(strtoupper(mb_substr($w['name'], 0, 1))) . '</span>';
        echo '<small>' . h($w['name']) . '</small></a>';
    }
    // App-Store immer erreichbar
    echo '<a class="lapp" href="' . url('store') . '"><span class="lico" style="--tc:#4d7ea8">' . icon('download', 22) . '</span><small>App-Store</small></a>';
...
function render_store(array $u): void {
    layout_topbar('App-Store', count(nx_webapps()) + count(nx_store_builtins()) . ' Apps', '', url('home'));
    $inst = nx_installed($u);
    $apps = nx_apps();

    $btn = static function (string $id, bool $on): string {
        $act = $on ? 'remove' : 'install';
        $cls = $on ? 'btn ghost sm' : 'btn sm';
        $lbl = $on ? 'Entfernen' : 'Hinzufügen';
        return '<form method="post" action="?app=store&action=' . $act . '" style="margin:0">' . csrf_field()
            . '<input type="hidden" name="id" value="' . h($id) . '"><button class="' . $cls . '">' . $lbl . '</button></form>';
    };
    $card = static function (string $id, string $name, string $desc, string $color, string $ico, bool $on) use ($btn): string {
        $out  = '<div class="ccard wacard" data-name="' . h(mb_strtolower($name)) . '"><div class="chead">';
        $out .= '<span class="avatar" style="background:color-mix(in srgb,' . $color . ' 16%,transparent);color:' . $color . '">' . $ico . '</span>';
        $out .= '<span class="cname"><strong>' . h($name) . '</strong><small>' . h($desc) . '</small></span></div>';
        $out .= '<div class="cbody"><div class="store-act">' . $btn($id, $on) . '</div></div></div>';
        return $out;
    };

    echo '<input class="input" id="storeSearch" placeholder="App suchen…" style="max-width:560px;margin-bottom:14px" oninput="storeFilter(this.value)">';

    echo '<div class="section-h">' . icon('grid') . ' Nexus-Apps</div><div class="cgrid" data-store-group>';
    foreach (nx_store_builtins() as $id) {
    ...
    foreach ($byCat as $cat => $list) {
        echo '<div class="section-h">' . icon('download') . ' ' . h($cat) . '</div><div class="cgrid" data-store-group>';
        foreach ($list as $wid => $w) {
            $id = 'web:' . $wid;
            $col = nx_wa_color($w['name']);
            $ico = empty($w['embed'])
                ? h(strtoupper(mb_substr($w['name'], 0, 1)))
                : icon($w['kind'] === 'player' ? 'video' : 'pin', 17);
            $desc = empty($w['embed']) ? 'Öffnet die Seite' : 'Läuft in Nexus';
            echo $card($id, $w['name'], $desc, $col, $ico, in_array($id, $inst, true));
        }
        echo '</div>';
    }
    echo '<p class="note-line" style="max-width:560px;margin-top:14px">„Läuft in Nexus" wird direkt eingebettet. '
        . '„Öffnet die Seite" führt zur echten Website – viele große Anbieter (Amazon, Google, Social Media …) '
        . 'verbieten das Einbetten technisch, deshalb öffnen sie als schneller Shortcut.</p>';
}
...
function render_web(array $u): void {
    ...
    $GLOBALS['nx_frame_src'] = $w['frame']; // wird von sec_headers/layout_head genutzt
    layout_topbar($w['name'], '', '<a class="btn ghost sm" href="' . url('store') . '">' . icon('cog', 15) . ' Store</a>', url('home'));

    $needsInput = in_array($w['kind'] ?? 'embed', ['youtube', 'spotify', 'soundcloud', 'vimeo', 'twitch', 'gmaps'], true);
    $v = param('v');
    $src = nx_embed_src($wid, $w, $v);
    ...
    if ($needsInput) {
        ...
        echo '<input class="input" name="v" placeholder="' . h($w['hint'] ?? 'Link einfügen') . '" value="' . h($v) . '">';
        echo '<button class="btn">Los</button></form>';
        if ($src !== '') {
            $audio = in_array($w['kind'], ['spotify', 'soundcloud'], true);
            echo '<div class="' . ($audio ? 'embed-audio' : 'embed-16x9') . '"><iframe src="' . h($src)
                . '" allow="autoplay;encrypted-media;fullscreen;picture-in-picture;clipboard-write" allowfullscreen loading="lazy"></iframe></div>';
        } else {
            echo '<div class="empty">' . icon($w['kind'] === 'gmaps' ? 'pin' : 'video', 40) . '<h3>' . h($w['name']) . '</h3><p>' . h($w['hint'] ?? '') . '</p></div>';
        }
        echo '</div>';
        return;
    }
    echo '<div class="embed-full"><iframe src="' . h($src) . '" allowfullscreen referrerpolicy="no-referrer" loading="lazy"></iframe></div>';
}
...
// Web-App-Viewer: CSP-Frame-Host vor dem Header setzen
if ($nxApp === 'web') {
    $wid = preg_replace('/[^a-z0-9_]/', '', strtolower(param('id')));
    $cat = nx_webapps();
    if (isset($cat[$wid]) && !empty($cat[$wid]['embed'])) {
        $GLOBALS['nx_frame_src'] = $cat[$wid]['frame'];
    }
}
