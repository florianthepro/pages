...
function asset_css(): string {
    return <<<'NXCSS'
/* Nexus v4 – ruhiges, weiches Interface, jetzt vollständig dynamisch:
   fluide Abstände/Typo per clamp(), dvh gegen iOS-Adressleisten-Sprünge,
   Safe-Area-Insets, kompakte Rasterung auf kleinen Handys (iPhone SE)
   bis großzügig auf dem PC. Rein visuell, keine Logikänderung. */
:root{
  --accent:#5b93d6;
...
@media(max-width:880px){
  ...
  .sidebar{position:fixed;left:calc(-1 * (260px + var(--safe-l)));z-index:40;width:min(84vw,280px);transition:left .2s;box-shadow:var(--shadow)}
  .sidebar.open{left:0}
