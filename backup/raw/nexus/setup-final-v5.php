...
.sidebar{background:var(--panel);border-right:0;padding:18px 14px;padding-left:max(14px,var(--safe-l));display:flex;flex-direction:column;gap:2px;position:sticky;top:0;height:100vh;height:100dvh;overflow-y:auto;overscroll-behavior:contain}
...
.quota{margin-top:14px;padding:12px;border-radius:12px;background:var(--panel2)}
...
function render_contacts(array $u): void {
    ...
    echo '<input type="hidden" name="id" value=""><input type="hidden" name="me" value="">';
...
function render_settings(array $u): void {
    ...
    echo '<div class="section-h">' . icon('user') . ' Profil</div><div class="panel" style="max-width:560px">';
